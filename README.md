...
[![Publish Docker image](https://github.com/SeyedHashtag/chatgpt-telegram-bot/actions/workflows/publish.yaml/badge.svg)](https://github.com/SeyedHashtag/chatgpt-telegram-bot/actions/workflows/publish.yaml)
...
### Plugins
![plugins](https://github.com/SeyedHashtag/chatgpt-telegram-bot/assets/11541888/83d5e0cd-e09a-463d-a292-722f919e929f)
...
If you'd like to help, check out the [issues](https://github.com/SeyedHashtag/chatgpt-telegram-bot/issues) section and contribute!  
If you want to help with translations, check out the [Translations Manual](https://github.com/SeyedHashtag/chatgpt-telegram-bot/discussions/219)
...
Check out the [Budget Manual](https://github.com/SeyedHashtag/chatgpt-telegram-bot/discussions/184) for possible budget configurations.
...
| `BOT_LANGUAGE`                      | Language of general bot messages. Currently available: `en`, `de`, `ru`, `tr`, `it`, `fi`, `es`, `id`, `nl`, `zh-cn`, `zh-tw`, `vi`, `fa`, `pt-br`, `uk`, `ms`, `uz`, `ar`.  [Contribute with additional translations](https://github.com/SeyedHashtag/chatgpt-telegram-bot/discussions/219) | `en`                               |
...
```shell
git clone https://github.com/SeyedHashtag/chatgpt-telegram-bot.git
...
You can also use the Docker image from [Docker Hub](https://hub.docker.com/r/SeyedHashtag/chatgpt-telegram-bot):
```shell
docker pull SeyedHashtag/chatgpt-telegram-bot:latest
docker run -it --env-file .env SeyedHashtag/chatgpt-telegram-bot
```

or using the [GitHub Container Registry](https://github.com/SeyedHashtag/chatgpt-telegram-bot/pkgs/container/chatgpt-telegram-bot/):

```shell
docker pull ghcr.io/SeyedHashtag/chatgpt-telegram-bot:latest
docker run -it --env-file .env ghcr.io/SeyedHashtag/chatgpt-telegram-bot
```
